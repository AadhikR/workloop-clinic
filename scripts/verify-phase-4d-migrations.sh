...
# Per-concern Alembic round-trip gate for Phase 4D. Confirms each of the three
# Phase 4D revisions (triggers, functions, grants) applies and reverts
# independently on top of the Phase 4C head with no metadata drift, and that the
# recorded head is the grants revision. Leaves the database at the full head.
...
CHAIN="8e2b6a4c1f07 9f3c7b5d2a18 a0d4e6f8c92b"
HEAD="a0d4e6f8c92b"
...
for revision in 9f3c7b5d2a18 8e2b6a4c1f07 "$C_HEAD"; do
