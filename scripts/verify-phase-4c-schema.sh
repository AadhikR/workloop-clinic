...
# Phase 4C schema gate. Proves the 65 business tables exist, that a connected row
...
BEGIN
  ...
  INSERT INTO shifts (id, company_id, branch_id, name, start_time, end_time)
    VALUES ('00000000-0000-0000-0000-000000000201', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000011', 'Day', '08:00', '16:00');
