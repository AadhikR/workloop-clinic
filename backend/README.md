...
This directory contains the portable Python backend that will replace direct browser access to Supabase. Phase 2B creates only the package and dependency foundation. FastAPI endpoints, database connections, migrations, containers, and Keycloak integration are added in later parts.
...
- Do not create a database connection until Phase 2C.
