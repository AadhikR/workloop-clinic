...
ERROR_REGISTRY: dict[str, ErrorSpec] = {
    ...
    "employment_transition_conflict": ErrorSpec(409, "Employment state changed"),
    "manager_reassignment_conflict": ErrorSpec(409, "Reporting relationships changed"),
    ...
    "roster_publication_not_ready": ErrorSpec(409, "Roster month is not ready to publish"),
    ...
    "report_source_unavailable": ErrorSpec(503, "Report source is unavailable"),
