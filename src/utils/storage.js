...
const offboardingCutoverError = () => new Error(
  'Legacy offboarding and gratuity access is disabled after the Phase 11G cutover.'
);

export async function getOffboardingChecklist() { throw offboardingCutoverError(); }
export async function createOffboardingChecklist() { throw offboardingCutoverError(); }
export async function getOffboardingTasks() { throw offboardingCutoverError(); }
export async function updateOffboardingTask() { throw offboardingCutoverError(); }
export async function addOffboardingTask() { throw offboardingCutoverError(); }
export async function deleteOffboardingTask() { throw offboardingCutoverError(); }
export async function saveOffboardingVisaStatus() { throw offboardingCutoverError(); }
export async function completeOffboardingChecklist() { throw offboardingCutoverError(); }
