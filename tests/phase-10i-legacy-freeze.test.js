...
test('legacy shift swap reads and writers fail closed after Phase 10I cutover', () => {
  const expected = new Map([
    ['getShiftSwapRequests', /moved to the migration roster workspace/i],
    ['updateShiftSwapRequest', /moved to the migration roster workspace/i],
    ['getMyColleagues', /migration employee workspace/i],
    ['requestShiftSwap', /moved to the migration employee workspace/i],
  ])
