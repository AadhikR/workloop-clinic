...
const errorContract = new Map([
  ...
  ['stale_financial_state', [409, 'conflict']],
  ...
  ['attendance_configuration_conflict', [409, 'conflict']],
  ['shift_conflict', [409, 'conflict']],
  ['retained_shift', [409, 'conflict']],
  ['shift_assignment_conflict', [409, 'conflict']],
  ...
  ['idempotency_key_reused', [409, 'conflict']],
